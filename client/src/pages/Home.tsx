...
export default function Home() {
  ...
  const scrollProjectToTop = (event: React.MouseEvent<HTMLButtonElement>) => { const surface = event.currentTarget.closest<HTMLElement>(".project-view"); surface?.scrollTo({ top: 0, behavior: window.matchMedia("(prefers-reduced-motion: reduce)").matches ? "auto" : "smooth" }); };
