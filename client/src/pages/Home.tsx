...
export default function Home() {
  ...
  const openProject = (project: PortfolioProject) => { setSelected(project); setMediaIndex(0); setFullscreenOpen(false); setFullscreenClosing(false); resetZoom(); };
