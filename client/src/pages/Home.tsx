...
export default function Home() {
  ...
  return (
    <main className={`site-shell${darkMode ? " dark-mode" : ""}`}>
      ...
      <section className="statement" id="sobre"><span className="section-index">02</span><div className="statement-copy"><h2>Entre o documento<br />e a <em>atmosfera.</em></h2><p>Deva Braga é fotógrafo e designer gráfico em Salvador. Seu trabalho percorre pessoas, lugares e marcas em busca de uma imagem que carregue presença.</p><a href="#contato">Conheça o processo <ArrowUpRight size={17} /></a></div><figure className="statement-portrait"><img className="protected-media" draggable={false} onContextMenu={event => event.preventDefault()} src="/manus-storage/portfolio/about/fotoperfildevacircular_688f59af.png" alt="Retrato de Deva Braga diante do mar" loading="lazy" /><figcaption>Deva Braga / Salvador</figcaption></figure></section>
