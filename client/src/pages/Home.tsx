...
export default function Home() {
  ...
  return (
    <main className={`site-shell${darkMode ? " dark-mode" : ""}`}>
      ...
      {showBackToTop && <button type="button" className="back-to-top" onClick={scrollToTop} aria-label="Voltar ao topo" title="Voltar ao topo"><ArrowUp size={17} /><span>Topo</span></button>}
